...
def getDiscountPercentage(in_original_price):
    discount_percentage = 0
    # verify and set discount percetage
    if in_original_price < 100: # 0 to 99 - 10% discount
        discount_percentage = 10
    elif in_original_price < 200: # from 100 to 199 - 15% discount
        discount_percentage = 15
    elif in_original_price < 300: # from 200 to 299 - 25% discount
        discount_percentage = 25
    elif in_original_price < 600: # from 300 to 599 - 35% discount
